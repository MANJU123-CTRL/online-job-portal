  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+91) 9845775298</p>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          TechNova Solutions Pvt. Ltd.<br>
           Pin-560037 Bangalore</address>
          <p>
            <i class="icon-phone"></i> (+91) 9845775298 <br>
            <i class="icon-envelope-alt"></i> parama2026@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; TechNova 2025 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
